    ...
    <div class="contact_main">
      ...
      <div class="contact-sec">
        <div className="services-heading">
          ...
          >
            <h1 class="text-black-900 text-4xl pt-4 font-semibold">
              Contact Us
            </h1>
          </motion.div>
          ...
          <div class="right_sec w-lg">
            ...
            <div class="contact">
              ...
              <div className="contact-footer-socials gap-5">
                <a
                  href="https://www.facebook.com/archana.ekka.77"
                ...
                <a
                  href="https://www.linkedin.com/in/archana-ekka-99a563333/"
                  className="social-icon"
                >
                  {" "}
                  <img
                ...
                <a
                  href="https://www.instagram.com/archanaekka00/"
                  className="social-icon"
                >
                  <img
                    class="socials-icon"
